/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: b79071cebb7e9e4acc5ad96edd351d12)
// Runtime types generated with workerd@1.20260521.1 2026-05-09 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PUBLIC_BASE_URL: "https://relay.vaexil.tv";
	TWITCH_REDIRECT_URI: "https://relay.vaexil.tv/oauth/twitch/callback";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "TWITCH_REDIRECT_URI">> {}
}
